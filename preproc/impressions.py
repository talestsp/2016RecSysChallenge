...
arq = open("/home/tales/development/recsys2016/data/parts2/impressions_part_" + index + ".csv", "r")
...
arq = open("/home/tales/development/recsys2016/data/parts2/impressions_clean_part_" + index + ".csv", "w")
